  ...
  events = [
    {
      ...
      category: 'Sport / Echipă',
      description:
        'Hai la un meci amical de fotbal! Vino cu prietenii sau singur, formăm echipele la fața locului. Perfect pentru a face mișcare și a te relaxa după cursuri.',
    ...
    },
    {
      ...
      category: 'Sport',
      description:
        'Campionat prietenos de baschet 3 la 3. Nu contează nivelul de experiență, toată lumea este binevenită. Mingile sunt asigurate de noi!',
      ...
      reviews: 31,
      image:
        'https://images.unsplash.com/photo-1519861531473-920026073fd6?auto=format&fit=crop&q=80&w=600',
    },
    {
      id: 3,
      ...
      description:
        'Relaxează-te cu un meci ad-hoc de tenis de masă. Atmosferă lejeră, muzică bună și competiție prietenoasă. Avem palete, dar o poți aduce și pe a ta!',
  ...
  get filteredEvents() {
    return this.events.filter((event) => {
      ...
      const matchesCategory =
        this.selectedCategory === 'Toate Categoriile' || event.category === this.selectedCategory;

      let matchesDate = true;
      if (this.selectedDate === 'Săptămâna aceasta')
        matchesDate = event.date.includes('18') || event.date.includes('20');
